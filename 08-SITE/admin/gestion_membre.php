...
//EXERCICE
/*  1-Seul l'administrateur doit avoir accès a cette page. Les autres son redirigés vers la page de connexion.

2-Afficher tous les membres inscrits dans une table HTML, avec toutes les info du membre SAUF son mot de passe.Vous ajoutez une colonne "action".

3-Afficher le nombre de membres inscrits

4-Dans la colonne "action", ajoutez un lien "supprimer" pour supprimer un membre inscrit, sauf vous meme qui etes connecté

5-bonus : dans la colonne "action", ajoutez un lien pour pouvoir modifier le statut des membres pour en faire un admin ou un membre, sauf vous meme qui etes connecté
...
if(!estAdmin())// verfifie si nous somme administrateur
{
...
$contenu .=  '<table class="table">';
		...
		$contenu .=  '<tr>';
			...
			$contenu .=  '<th> email </th>';
			$contenu .=  '<th> civilité </th>'; //------------------A memoriser refair et travailler deçu!
			$contenu .=  '<th> ville </th>';
